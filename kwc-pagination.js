...
import { button, soft } from '@kano/styles/button.js';
// Missing from button.js
...
class KWCPagination extends PolymerElement {
    static get template() {
        ...
        <template is="dom-if" if="[[jumpControls]]">
            <button class="btn soft first" on-click="_goToFirstPage" disabled$="[[_isFirstPage(currentPage, totalPages)]]">
                <slot name="firstPage">&lt;&lt;</slot>
            </button>
        </template>

        <template is="dom-if" if="[[paginationControls]]">
            <button class="btn soft previous" on-click="_previousPage" disabled$="[[_isFirstPage(currentPage, totalPages)]]">
                <slot name="previousPage">PREV</slot>
            </button>
        </template>

        <template is="dom-repeat" items="[[_pages]]">
            <button class="btn soft item" active$="[[_isActive(item, currentPage)]]" on-click="_goToPage">
                [[item]]
            </button>
        </template>

        <template is="dom-if" if="[[paginationControls]]">
            <button class="btn soft next" on-click="_nextPage" disabled$="[[_isLastPage(currentPage, totalPages)]]">
                <slot name="nextPage">NEXT</slot>
            </button>
        </template>

        <template is="dom-if" if="[[jumpControls]]">
            <button class="btn soft last" on-click="_goToLastPage" disabled$="[[_isLastPage(currentPage, totalPages)]]">
